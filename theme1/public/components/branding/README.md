...
- `branding.css` - Complete styling and animations
- `branding.js` - JavaScript functionality and Streamer.bot integration
...
Edit CSS variables in `branding.css`:
...
For remote Streamer.bot instance, edit `branding.js`:
